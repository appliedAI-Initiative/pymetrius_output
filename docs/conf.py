# -*- coding: utf-8 -*-
#
# pymetrius_output documentation build configuration file
#
...
def linkcode_resolve(domain, info):
    link_prefix = (
        "https://github.com/appliedAI-Initiative/pymetrius_output/blob/develop"
    )
    if domain != "py":
        return None
    if not info["module"]:
...
htmlhelp_basename = "pymetrius_output_doc"
...
man_pages = [("index", "pymetrius_output", "", ["automated_user"], 1)]
